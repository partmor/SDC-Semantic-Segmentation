...
def run():
    ...
    with tf.Session() as sess:
        ...
        fcn_last_layer = layers(vgg_layer3, vgg_layer4, vgg_layer7, num_classes)
        logits, train_op, cross_entropy_loss = optimize(fcn_last_layer, correct_label, learning_rate, num_classes)
